...
public class CustomerLandingScreenUITest extends UITestCaseSwing {

	/**
	 * Create an Instance
	 */
	public CustomerLandingScreenUITest() {
	 ...
	 * Main test method.
	 */
	public void testCustomerLandingScreenUI() throws Exception {
		IUIContext ui = getUI();
